...
3. **Datadog Agent マニフェストを作成**。以下のテンプレートを使用して、`datadog-agent.yaml` マニフェストを作成します
    ...
    |---------|------|-----|---------|-----|------------------------|-------------------------|
    | ✓       | ✓    | ✓   | ✓       |     | [マニフェストテンプレート][3] | [マニフェストテンプレート][4] |
    | ✓       | ✓    | ✓   |         |     | [マニフェストテンプレート][5] | [マニフェストテンプレート][6] |
    | ✓       | ✓    |     |         |     | [マニフェストテンプレート][7] | [マニフェストテンプレート][8] |
    | ✓       |      | ✓   |         |     | [マニフェストテンプレート][9] | [マニフェストテンプレート][10] |
    |         |      |     |         | ✓   | [マニフェストテンプレート][11] | テンプレートなし             |
    | ✓       |      |     |         |     | [マニフェストテンプレート][12] | [マニフェストテンプレート][13] |
