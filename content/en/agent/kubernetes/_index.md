...
3. **Create the Datadog Agent manifest**. Create the `datadog-agent.yaml` manifest out of one of the following templates
    ...
    |---------|------|-----|---------|-----|------------------------|-------------------------|
    | ✓       | ✓    | ✓   | ✓       |     | [Manifest template][3] | [Manifest template][4] |
    | ✓       | ✓    | ✓   |         |     | [Manifest template][5] | [Manifest template][6] |
    | ✓       | ✓    |     |         |     | [Manifest template][7] | [Manifest template][8] |
    | ✓       |      | ✓   |         |     | [Manifest template][9] | [Manifest template][10] |
    |         |      |     |         | ✓   | [Manifest template][11] | no template             |
    | ✓       |      |     |         |     | [Manifest template][12] | [Manifest template][13] |
